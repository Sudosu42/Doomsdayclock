...
6. GLue the LCD into the main case, do your best to make sure the LCD is centered and the PCB should be as flush as possible inside the lip of the main case.
